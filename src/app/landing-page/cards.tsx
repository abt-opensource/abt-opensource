...
const cardData = [
  ...
  },
  {
    ...
    description: "High-performance bundler for React Server Components and TypeScript codebases.",
  },
];
...
<div key={index} className="">
            <div
              className="card-content w-[380px] rounded-xl bg-cardBg p-8 text-center shadow-lg backdrop-blur-lg transition-transform duration-300 hover:shadow-lg"
            >
